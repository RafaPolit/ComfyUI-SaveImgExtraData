...
class Save_img_extra_data:
    ...
    RETURN_TYPES = ()
    FUNCTION = "Save_img_extra_data"
    OUTPUT_NODE = True

    CATEGORY = "IO"

    def Save_img_extra_data(self,
                        images,
                        output_path=None,
        ...
        if output_path.strip() != '':
            if not os.path.exists(output_path.strip()):
                print(Fore.GREEN + "+ The specified path doesn\'t exist! Creating directory.")
                os.makedirs(output_path, exist_ok=True)
        if output_data_path.strip() != '':
            if not os.path.exists(output_data_path.strip()):
                print(Fore.GREEN + "+ The specified data path doesn\'t exist! Creating directory.")
        ...
        for image in images:
            ...
            try:
                ...
                prompt_output_file = os.path.abspath(os.path.join(output_data_path, prompt_file))
...
NODE_CLASS_MAPPINGS = {
    "Save IMG Extra Data": Save_img_extra_data
}
